...
public class NumberGreaterThanRequirement extends Requirement {

    private final String input , output;

    public NumberGreaterThanRequirement(String name , String input , String output , boolean positive ) {
        super( name , "number greater than" , positive );
        this.input = input;
        this.output = output;
    }
    ...
    public LinkedHashMap<String, Object> serialize() {
        ...
        if ( ! isPositive() ) result.put( "type" , "!number greater than" );
